        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daftar Penyakit</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <!-- /.panel-heading -->
                         <div class="panel-body" align="center">
                          <form action="<?php echo base_url().'Brhsluts/update/';?>" method="post">
                            <div class="col-md-1">
                                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addNewdosen">Tambah Data Penyakit</button>
                            </div>
                            <br><br>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                     <?php 
                                        ...
                                        <td>
                                            <button type="button" class=""><?php echo anchor('Penyakit/edit/' . $p->kode_penyakit,'Edit' ); ?></button> 
                                            <button type="button" class="btn btn-danger"><?php echo anchor('Penyakit/delete/' . $p->kode_penyakit,'Hapus' ); ?></button>
                                        </td>
                            ...
                            <form action="<?php echo base_url('Penyakit/add'); ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="modal-header">
                                    <h5 class="col-md-3"  id="exampleModalLabel">Tambah Data Penyakit</h5>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <input class="form-control" type="text" name="kode_penyakit" placeholder="kode Penyakit">
                                    </div>
                                </div>
                                <div class="form-group row">
