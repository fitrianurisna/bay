        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Daftar Gejala</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <!-- /.panel-heading -->
                         <div class="panel-body" align="center">
                          <form action="<?php echo base_url().'Brhsluts/update/';?>" method="post">
                            <div class="col-md-1">
                                <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addNewdosen">Tambah Data Gejala</button>
                            </div>
                            <br><br>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                     <?php 
                                        ...
                                        foreach ($gejala as $p)  {?>
                                        <td><?php echo $no++ ?></td>
                                        <td><?php echo $p->kode_gejala; ?></td>
                                        <td><?php echo $p->nama_gejala; ?></td>
                                        <td>
                                            <button type="button" class=""><?php echo anchor('Gejala/edit/' . $p->kode_gejala,'Edit' ); ?></button> 
                                            <button type="button" class="btn btn-danger"><?php echo anchor('Gejala/delete/' . $p->kode_gejala,'Hapus' ); ?></button>
                                        </td>
                            ...
                            <form action="<?php echo base_url('Gejala/add'); ?>" method="post" enctype="multipart/form-data">
                                <div class="modal fade" id="addNewdosen" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                  <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="col-md-3"  id="exampleModalLabel">Tambah Data Gejala</h5>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9 col-sm-9 ">
                                        <input class="form-control" type="text" name="kode_gejala" placeholder="kode Gejala">
                                    </div>
                                </div>
                                <div class="form-group row">
